...
<a href="dashboard.php" ><i class="fa fa-arrow-left fa-2x" style="width:40px;float:left;color:#0a4981;margin-top:-30px"></i></a>
  ...
  <div class="main" >
    ...
    <div id="wrapper" class="wrapper_w3layouts" style="margin-top:-50px">
      <form action="exe.php" class="testform" id="testform" method="post" enctype="multipart/form-data" >
        <fieldset class="personal-data w3_agileits_field">
          <span class="w3l_personal">
            <label class="agileits_label" for="name">Bulletin(For The Week): <i class="required">*</i></label>
            <input type="text" id="name" name="bul" placeholder="Amount" />
          </span>
          <span class="w3l_personal">
            <label class="agileits_label" for="name">Fuel (For The Week): <i class="required">*</i></label>
            <input type="text" id="name" name="fue" placeholder=" Amount" />
          </span>
        ...
        <fieldset class="address-data-inputs w3_agileits_field agileinfo_field" style="margin-top:-10px">
         <span class="w3l_personal">
            <label class="agileits_label" for="name">Electricity Bill: <i class="required"></i></label>
            <input type="text" id="name" name="ele" placeholder="Amount" />
          </span>
           <span class="w3l_personal">
            <label class="agileits_label" for="name">Pastor: <i class="required"></i></label>
            <input type="text" id="name" name="pas" placeholder="Amount" />
          </span>
        </fieldset>
        ...
        <fieldset class="message-details w3_agileits_field">
          ...
          <span class="w3l_personal">
            <label class="agileits_label" for="name"> Others: <i class="required">*</i></label>
            <input type="text" id="name" name="oth" placeholder="Amount" />
          </span>
           <span class="w3l_personal">
