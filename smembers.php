           ...
           <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-user"></i>Admin </a>
              ...
              <li><a href="sattendance.php"> <i class="fa fa-user"></i>Attendance(Sunday) </a></li>
                    <li><a href="new.php"> <i class="fa fa-user"></i>Attendance (Other Service)</a></li>  
                     <li><a href="#"> <i class="fa fa-user"></i>All members </a></li>
    ...
    <div class="page">
      ...
      <section>
        <div class="container-fluid">
          ...
          <!-- Page Header-->
            <header> 
            <h1 class="h3 display"> All Members (Based On Their Month)</h1>
          </header>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from member_tb where month='January' and church = '$_SESSION[cname]'");
...
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      ...
                      <thead>
                        <tr>
                          <th>#</th>
                            <th style='color:#0a4981;'>Surname</th>
                          <th style='color:#0a4981;'>Firstname</th>
                          <th style='color:#0a4981;'>Lastname</th>
                          <th style='color:#0a4981;'>Email</th>
                          <th style='color:#0a4981;'>Phone</th>
                           <th style='color:#0a4981;'>Month</th>
                          <th style='color:#0a4981;'>Address</th>
                          <th style='color:#0a4981;'>Town</th>
                          <th style='color:#0a4981;'>State</th>
                          <th style='color:#0a4981;'>Country</th>
                          <th style='color:#0a4981;'> Date</th>
                          <th style='color:#0a4981;'>Time</th>
                           <th style='color:#0a4981;'>Edit Profile</th>
...
while ($r = mysqli_fetch_array($result)) {
  $id = $r ['member_id'];
  echo  "<tr><td>".$id."</td><td>".$r['surname']."</td><td>".$r['firstname']."</td><td>".$r['lastname']."</td><td>".$r['email']."</td><td>".$r['phone']."</td><td>".$r['month']."</td><td>".$r['address']."</td><td>".$r['town']."</td><td>".$r['state']."</td><td>".$r['country']."</td><td>".$r['date']."</td><td>".$r['time']."</td><td><a href='edit.php?id=$id'><input type='submit'name='edit data'value='Edit'id='myBtn' class='add btn btn' style='background:#0a4981;color:white;'/></a>
 </td>"."</td>
</tr>";
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from member_tb where month='February' and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from member_tb where month='March'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from member_tb where month='April'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from member_tb where month='May'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from member_tb where month='June'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from member_tb where month='July'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from member_tb where month='August'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from member_tb where month='September'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from member_tb where month='October'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from member_tb where month='November'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from member_tb where month='December'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
