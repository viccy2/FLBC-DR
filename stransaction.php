          ...
          <ul id="side-admin-menu" class="side-menu list-unstyled"> 
           <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-user"></i>Admin </a>
              <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                    ...
                    <li><a href="#.php"> <i class="fa fa-user"></i>All Income </a></li>
                   ...
                   <li><a href="sattendance.php"> <i class="fa fa-user"></i>Attendance(Sunday) </a></li>
                    <li><a href="new.php"> <i class="fa fa-user"></i>Attendance (Other Service)</a></li>                   <li><a href="smembers.php"> <i class="fa fa-user"></i>All members </a></li>
    ...
    <div class="page">
      ...
      <section>
        <div class="container-fluid">
          ...
          <!-- Page Header-->
            <header> 
            <h1 class="h3 display"> All Income (Based On  Month)</h1>
          </header>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from income_tb where month='January'and church = '$_SESSION[cname]'");
...
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      ...
                      <thead>
                        <tr>
                          <th>#</th>
                            <th style='color:#0a4981;'>Tithes</th>
                          <th style='color:#0a4981;'>Offering(Adult)</th>
                          <th style='color:#0a4981;'>Sunday School(Adult)</th>
                          <th style='color:#0a4981;'>Birthday Thanksgiving</th>
                          <th style='color:#0a4981;'>End Of The Year Thanksgiving</th>
                           <th style='color:#0a4981;'>Family Thanksgiving</th>
                           <th style='color:#0a4981;'>Harvest Thanksgiving</th>
                          <th style='color:#0a4981;'>Mid-Year Thanksgiving</th>
                          <th style='color:#0a4981;'>Monthly Thanksgiving</th>
                          <th style='color:#0a4981;'>New Year Thanksgiving</th>
                          <th style='color:#0a4981;'>Other Thanksgiving</th>
                          <th style='color:#0a4981;'>Project Thanksgiving</th>
                          <th style='color:#0a4981;'>Special Thanksgiving</th>
                          <th style='color:#0a4981;'>Offering(Children)</th>
                          <th style='color:#0a4981;'>Sunday School(Children)</th>
...
while ($r = mysqli_fetch_array($result)) {
  $id = $r ['income_id'];
  echo  "<tr><td>".$id."</td><td>".'#'.$r['item1']."</td><td>".'#'.$r['item2']."</td><td>".'#'.$r['item3']."</td><td>".'#'.$r['item4']."</td><td>".'#'.$r['item5']."</td><td>".'#'.$r['item6']."</td><td>".'#'.$r['item7']."</td><td>".'#'.$r['item8']."</td><td>".'#'.$r['item9']."</td><td>".'#'.$r['item10']."</td><td>".'#'.$r['item11']."</td><td>".'#'.$r['item12']."</td><td>".'#'.$r['item13']."</td><td>".'#'.$r['item14']."</td><td>".'#'.$r['item15']."</td><td>".$r['month']."</td><td>".'#'.$r['total']."</td><td>".$r['date']."</td><td>".$r['time']."</td>"."<td>".$r['edit']."</td>
 </td>"."</td>
</tr>";
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from income_tb where month='February'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from income_tb where month='March'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from income_tb where month='April'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from income_tb where month='May'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
require 'dc.php';
$result = mysqli_query($con, "select * from income_tb where month='June'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
require 'dc.php';
$result = mysqli_query($con, "select * from income_tb where month='July'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
require 'dc.php';
$result = mysqli_query($con, "select * from income_tb where month='August'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
require 'dc.php';
$result = mysqli_query($con, "select * from income_tb where month='September'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
$result = mysqli_query($con, "select * from income_tb where month='October'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
$result = mysqli_query($con, "select * from income_tb where month='November'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
$result = mysqli_query($con, "select * from income_tb where month='December'and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
