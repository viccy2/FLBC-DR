          ...
          <ul id="side-admin-menu" class="side-menu list-unstyled"> 
           <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-user"></i>Admin </a>
              <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                    ...
                    <li><a href="#"> <i class="fa fa-user"></i>Attendance (Other Service)</a></li>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from services_tb where month='January' and church='$_SESSION[cname]'");
                    ...
                    <table class='table table-striped'>
                      ...
                      <thead>
                        <tr>
                          ...
                          <th style='color:#0a4981;'>Service Name</th>
                          <th style='color:#0a4981;'>Attendance</th>
...
while ($r = mysqli_fetch_array($result)) {
  $id = $r ['services_id'];
  echo  "<tr><td>".$id."</td><td>".$r['item1']."</td><td>".$r['item2']."</td><td>".$r['month']."</td><td>".$r['date']."</td><td>".$r['time']."</td>"."<td>".$r['edit']."</td>"."</td>"."
</tr>";
