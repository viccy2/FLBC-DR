    ...
    <div class="page">
      ...
      <section>
        <div class="container-fluid">
          ...
          <!-- Page Header-->
            <header> 
            <h1 class="h3 display"> Attendance (Based On  Month)</h1>
          </header>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from service_tb where month='January' and church = '$_SESSION[cname]'");
                    ...
                    <table class='table table-striped'>
                      ...
                      <thead>
                        <tr>
                          ...
                          <th style='color:#0a4981;'>Sunday Service(Adult)</th>
                          <th style='color:#0a4981;'>Sunday Service(Children)</th>
...
while ($r = mysqli_fetch_array($result)) {
  $id = $r ['service_id'];
  echo  "<tr><td>".$id."</td><td>".$r['item1']."</td><td>".$r['item2']."</td><td>".$r['item3']."</td><td>".$r['item4']."</td><td>".$r['total']."</td><td>".$r['month']."</td><td>".$r['date']."</td><td>".$r['time']."</td>"."<td>".$r['edit']."</td>
 </td>"."</td>
</tr>";
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from service_tb where month='February' and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
while ($r = mysqli_fetch_array($result)) {
  $id = $r ['service_id'];
  echo  "<tr><td>".$id."</td><td>".$r['item1']."</td><td>".$r['item2']."</td><td>".$r['item3']."</td><td>".$r['item4']."</td><td>".$r['total']."</td><td>".$r['month']."</td><td>".$r['date']."</td><td>".$r['time']."</td>"."<td>".$r['edit'].
 "</td>"."</td>
</tr>";
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from service_tb where month='March' and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from service_tb where month='April' and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
<?php 
require 'dc.php';
$result = mysqli_query($con, "select * from service_tb where month='May' and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
require 'dc.php';
$result = mysqli_query($con, "select * from service_tb where month='June ' and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
require 'dc.php';
$result = mysqli_query($con, "select * from service_tb where month='July' and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
require 'dc.php';
$result = mysqli_query($con, "select * from service_tb where month='August' and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
require 'dc.php';
$result = mysqli_query($con, "select * from service_tb where month='September' and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
require 'dc.php';
$result = mysqli_query($con, "select * from service_tb where month='October' and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
require 'dc.php';
$result = mysqli_query($con, "select * from service_tb where month='November' and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
...
require 'dc.php';
$result = mysqli_query($con, "select * from service_tb where month='December' and church = '$_SESSION[cname]'");
// <table border=10 width=50% align=center style='margin-top:100px;color: white;background-color:#166A8F;border-color:#166A8F'><th>S/N</th><th>Surname</th><th>Firstname</th><th>Lastname</th></th><th>Change</th><th>Delete</th><th>Info</th>
echo " <div class='table-responsive' style='width:100%'>
                    <table class='table table-striped'>
                      <thead>
